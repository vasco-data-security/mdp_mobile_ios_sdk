Pod::Spec.new do |s|
  ...
  s.license      = { :type => 'Vasco', :text => 'Copyright (c) 2014 VASCO Data Security International GmbH. All rights reserved.' }
  s.author       = "VASCO Data Security International GmbH"
  s.platform     = :ios
  s.source       = { :git => "git@github.com:vasco-data-security/mdp_mobile_ios_sdk.git", :tag => "1.0.0" }
